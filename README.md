...
EUCLID+ divides the applied clock signal by any integer clock division (up to 31 countes) making EUCLID+ useful as a voltage-controlled hardware clock divider.
