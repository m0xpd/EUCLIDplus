...
[Strictly speaking, EUCLID+ usually produces the *rotation* of a Euclidean Rhythm (which is an instance of the same *'rhythm necklace'* as the Euclidean Rhythm), but EUCLID+ does occasionally produce a Euclidean Rhythm.]
