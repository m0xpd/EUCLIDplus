...
[Strictly speaking, EUCLID+ usually produces the *rotation* of a Euclidean Rhythm (which is an instance of the same *'[rhythm necklace](https://cgm.cs.mcgill.ca/~godfried/publications/banff.pdf)'* as the Euclidean Rhythm), but EUCLID+ does occasionally produce a Euclidean Rhythm.]

If you're looking for a module where you just dial in parameters and out pops a Euclidean Rhythm, this isn't for you. However, if you're interested in working with a creative platform on which you can explore possibilities in rhythm generation, and be open to the surprises which pop out along the way, EUCLID+ might be of interest. 
