...
EUCLID+ combines the clock input and the signal from the clock multiplier to provide patterns on the RHYTHM output. Their complements (i.e. triggers where there are no onsets on the Rhythm output) appear on the COMP output.
