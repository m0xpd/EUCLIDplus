...
Strictly speaking, EUCLID+ *usually* produces the *rotation* of a Euclidean Rhythm (which is an instance of the same *'[rhythm necklace](https://cgm.cs.mcgill.ca/~godfried/publications/banff.pdf)'* as the Euclidean Rhythm). EUCLID+ *occasionally* produces a Euclidean Rhythm.
